...
- **You see `port N held by sibling workspace ...` on stderr.** Expected when another worktree's omnibus server is bound to your starting port. `dev-up` walks past it; nothing to fix.
