...
| CodeQL | static security analysis of the Rust, TypeScript, Python, and workflow code; `tests.rs`, `tests/`, `test_support.rs`, and `ui_tests/` are excluded, inline `#[cfg(test)]` modules are not |
